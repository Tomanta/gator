...
func main() {
	...
	cmdList.register("follow", middlewareLoggedIn(handlerFollowFeed))
	cmdList.register("unfollow", middlewareLoggedIn(handlerUnfollowFeed))
	cmdList.register("following", middlewareLoggedIn(handlerListFollowedFeeds))
